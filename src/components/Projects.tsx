        ...
        {Object.values(projects).map((p: Project) => {
          return (
            <div
              key={p.slug}
              data-testid="item"
              className="flex flex-col px-7 py-8 gap-4 items-start justify-between hover:bg-light-dark border-[1px] border-dark-blue hover:border-l-8 pl-10 hover:pl-[33px8] hover:border-l-blue rounded-md cursor-pointer"
            >
